...
options = ["Nifty 500", "Nifty 100", "Nifty 200", "Nifty 50", "Nifty Next 50", "Nifty Midcap 150", "Nifty Midcap 50",
...
if st.button("Get Graph"):
    data = fetch_prices()
    if data is not None:
        df = data[["OPEN_INDEX_VAL", "HIGH_INDEX_VAL", "LOW_INDEX_VAL", "CLOSE_INDEX_VAL"]]
        st.line_chart(df)
